...
def train_knn(x_train, y_train, scalermodel):
...
if __name__ == "__main__":	
	...
	x_train, y_train, x_test, y_test, scaler = split_and_preprocess_trainingdata (training_data)
	knn = train_knn(x_train, y_train, scaler)
	validate_knn(knn, x_test, y_test)
	x_predict = preprocess_evaluationdata (evaluation_data, scaler)

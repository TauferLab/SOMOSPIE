        ...
        for MODEL in MODELS:
            ...
            for bash_suf, file_suf in suffixes[MODEL]:
                ...
                if (MODEL in ["HYPPO", "KNN", "SBM"]):
                    bash_args = [TRAVIS_MODEL, "-t", TR, "-e", EV, "-m", MODEL, "-o", PRD, "-l", LOG]
                elif (MODEL == "1NN"):
                    bash_args = [TRAVIS_MODEL, "-t", TR, "-e", EV, "-m", "KNN", "-o", PRD, "-s", 0, "-S", "1,2", "-v", 2, "-k", 1, "-l", LOG]
                elif (MODEL == "KKNN"):
                    bash_args = [MARIO_MODEL, "-t", TR, "-e", EV, "-o", PRD, "-l", LOG]
                elif (MODEL == "RF"):
